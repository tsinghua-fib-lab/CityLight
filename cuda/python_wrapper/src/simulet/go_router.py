...
if True:  # 排序保护
    ...
    from wolong.routing.v2.routing_pb2 import RouteType
    from wolong.routing.v2.routing_service_pb2 import (GetDrivingCostsRequest,
                                                       GetRouteRequest,
                                                       SetDrivingCostsRequest)
    from wolong.routing.v2.routing_service_pb2_grpc import RoutingServiceStub
