...
#ifndef GOOGLE_PROTOBUF_INCLUDED_wolong_2fagent_2fv2_2fagent_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_wolong_2fagent_2fv2_2fagent_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_wolong_2fagent_2fv2_2fagent_2eproto
...
struct TableStruct_wolong_2fagent_2fv2_2fagent_2eproto {
  static const uint32_t offsets[];
};
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_wolong_2fagent_2fv2_2fagent_2eproto;
namespace wolong {
namespace agent {
namespace v2 {
class Agent;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::wolong::agent::v2::Agent* Arena::CreateMaybeMessage<::wolong::agent::v2::Agent>(Arena*);
template<> ::wolong::agent::v2::AgentAttribute* Arena::CreateMaybeMessage<::wolong::agent::v2::AgentAttribute>(Arena*);
template<> ::wolong::agent::v2::Agent_LabelsEntry_DoNotUse* Arena::CreateMaybeMessage<::wolong::agent::v2::Agent_LabelsEntry_DoNotUse>(Arena*);
template<> ::wolong::agent::v2::Agents* Arena::CreateMaybeMessage<::wolong::agent::v2::Agents>(Arena*);
template<> ::wolong::agent::v2::BikeAttribute* Arena::CreateMaybeMessage<::wolong::agent::v2::BikeAttribute>(Arena*);
template<> ::wolong::agent::v2::BusAttribute* Arena::CreateMaybeMessage<::wolong::agent::v2::BusAttribute>(Arena*);
template<> ::wolong::agent::v2::VehicleAttribute* Arena::CreateMaybeMessage<::wolong::agent::v2::VehicleAttribute>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace wolong {
namespace agent {
namespace v2 {
...
constexpr AgentType AgentType_MAX = AGENT_TYPE_TAXI;
...
class AgentAttribute final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:wolong.agent.v2.AgentAttribute) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "wolong.agent.v2.AgentAttribute";
  }
  protected:
  ...
  // .wolong.agent.v2.AgentType type = 1;
  void clear_type();
  ::wolong::agent::v2::AgentType type() const;
  void set_type(::wolong::agent::v2::AgentType value);
  private:
  ::wolong::agent::v2::AgentType _internal_type() const;
  void _internal_set_type(::wolong::agent::v2::AgentType value);
  public:

  // @@protoc_insertion_point(class_scope:wolong.agent.v2.AgentAttribute)
 private:
  class _Internal;
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_wolong_2fagent_2fv2_2fagent_2eproto;
};
// -------------------------------------------------------------------

class VehicleAttribute final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:wolong.agent.v2.VehicleAttribute) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "wolong.agent.v2.VehicleAttribute";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:wolong.agent.v2.VehicleAttribute)
 private:
  class _Internal;
...
class BusAttribute final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:wolong.agent.v2.BusAttribute) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "wolong.agent.v2.BusAttribute";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:wolong.agent.v2.BusAttribute)
 private:
  class _Internal;
...
class BikeAttribute final :
    public ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:wolong.agent.v2.BikeAttribute) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "wolong.agent.v2.BikeAttribute";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:wolong.agent.v2.BikeAttribute)
 private:
  class _Internal;
...
public:
  ...
  static bool ValidateKey(std::string* s) {
    return ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(s->data(), static_cast<int>(s->size()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::PARSE, "wolong.agent.v2.Agent.LabelsEntry.key");
 }
  static bool ValidateValue(std::string* s) {
    return ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(s->data(), static_cast<int>(s->size()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::PARSE, "wolong.agent.v2.Agent.LabelsEntry.value");
 }
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadata() const final;
  friend struct ::TableStruct_wolong_2fagent_2fv2_2fagent_2eproto;
...
class Agent final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:wolong.agent.v2.Agent) */ {
 public:
  ...
  ::wolong::trip::v2::Schedule* mutable_schedules(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::wolong::trip::v2::Schedule >*
      mutable_schedules();
  private:
  const ::wolong::trip::v2::Schedule& _internal_schedules(int index) const;
  ::wolong::trip::v2::Schedule* _internal_add_schedules();
  public:
  const ::wolong::trip::v2::Schedule& schedules(int index) const;
  ::wolong::trip::v2::Schedule* add_schedules();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::wolong::trip::v2::Schedule >&
      schedules() const;
  ...
  // .wolong.agent.v2.AgentAttribute attribute = 2;
  bool has_attribute() const;
  private:
  bool _internal_has_attribute() const;
  public:
  void clear_attribute();
  const ::wolong::agent::v2::AgentAttribute& attribute() const;
  PROTOBUF_NODISCARD ::wolong::agent::v2::AgentAttribute* release_attribute();
  ::wolong::agent::v2::AgentAttribute* mutable_attribute();
  void set_allocated_attribute(::wolong::agent::v2::AgentAttribute* attribute);
  private:
  const ::wolong::agent::v2::AgentAttribute& _internal_attribute() const;
  ::wolong::agent::v2::AgentAttribute* _internal_mutable_attribute();
  public:
  void unsafe_arena_set_allocated_attribute(
      ::wolong::agent::v2::AgentAttribute* attribute);
  ::wolong::agent::v2::AgentAttribute* unsafe_arena_release_attribute();
  ...
  public:
  void clear_home();
  const ::wolong::geo::v2::Position& home() const;
  PROTOBUF_NODISCARD ::wolong::geo::v2::Position* release_home();
  ::wolong::geo::v2::Position* mutable_home();
  void set_allocated_home(::wolong::geo::v2::Position* home);
  private:
  const ::wolong::geo::v2::Position& _internal_home() const;
  ::wolong::geo::v2::Position* _internal_mutable_home();
  public:
  void unsafe_arena_set_allocated_home(
      ::wolong::geo::v2::Position* home);
  ::wolong::geo::v2::Position* unsafe_arena_release_home();

  // optional .wolong.agent.v2.VehicleAttribute vehicle_attribute = 7;
  bool has_vehicle_attribute() const;
  private:
  bool _internal_has_vehicle_attribute() const;
  public:
  void clear_vehicle_attribute();
  const ::wolong::agent::v2::VehicleAttribute& vehicle_attribute() const;
  PROTOBUF_NODISCARD ::wolong::agent::v2::VehicleAttribute* release_vehicle_attribute();
  ::wolong::agent::v2::VehicleAttribute* mutable_vehicle_attribute();
  void set_allocated_vehicle_attribute(::wolong::agent::v2::VehicleAttribute* vehicle_attribute);
  private:
  const ::wolong::agent::v2::VehicleAttribute& _internal_vehicle_attribute() const;
  ::wolong::agent::v2::VehicleAttribute* _internal_mutable_vehicle_attribute();
  public:
  void unsafe_arena_set_allocated_vehicle_attribute(
      ::wolong::agent::v2::VehicleAttribute* vehicle_attribute);
  ::wolong::agent::v2::VehicleAttribute* unsafe_arena_release_vehicle_attribute();

  // optional .wolong.agent.v2.BusAttribute bus_attribute = 8;
  bool has_bus_attribute() const;
  private:
  bool _internal_has_bus_attribute() const;
  public:
  void clear_bus_attribute();
  const ::wolong::agent::v2::BusAttribute& bus_attribute() const;
  PROTOBUF_NODISCARD ::wolong::agent::v2::BusAttribute* release_bus_attribute();
  ::wolong::agent::v2::BusAttribute* mutable_bus_attribute();
  void set_allocated_bus_attribute(::wolong::agent::v2::BusAttribute* bus_attribute);
  private:
  const ::wolong::agent::v2::BusAttribute& _internal_bus_attribute() const;
  ::wolong::agent::v2::BusAttribute* _internal_mutable_bus_attribute();
  public:
  void unsafe_arena_set_allocated_bus_attribute(
      ::wolong::agent::v2::BusAttribute* bus_attribute);
  ::wolong::agent::v2::BusAttribute* unsafe_arena_release_bus_attribute();

  // optional .wolong.agent.v2.BikeAttribute bike_attribute = 9;
  bool has_bike_attribute() const;
  private:
  bool _internal_has_bike_attribute() const;
  public:
  void clear_bike_attribute();
  const ::wolong::agent::v2::BikeAttribute& bike_attribute() const;
  PROTOBUF_NODISCARD ::wolong::agent::v2::BikeAttribute* release_bike_attribute();
  ::wolong::agent::v2::BikeAttribute* mutable_bike_attribute();
  void set_allocated_bike_attribute(::wolong::agent::v2::BikeAttribute* bike_attribute);
  private:
  const ::wolong::agent::v2::BikeAttribute& _internal_bike_attribute() const;
  ::wolong::agent::v2::BikeAttribute* _internal_mutable_bike_attribute();
  public:
  void unsafe_arena_set_allocated_bike_attribute(
      ::wolong::agent::v2::BikeAttribute* bike_attribute);
  ::wolong::agent::v2::BikeAttribute* unsafe_arena_release_bike_attribute();
  ...
  // @@protoc_insertion_point(class_scope:wolong.agent.v2.Agent)
 private:
  class _Internal;
  ...
  struct Impl_ {
    ...
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::wolong::trip::v2::Schedule > schedules_;
    ::PROTOBUF_NAMESPACE_ID::internal::MapField<
        Agent_LabelsEntry_DoNotUse,
        std::string, std::string,
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_STRING,
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_STRING> labels_;
    ::wolong::agent::v2::AgentAttribute* attribute_;
    ::wolong::geo::v2::Position* home_;
    ::wolong::agent::v2::VehicleAttribute* vehicle_attribute_;
    ::wolong::agent::v2::BusAttribute* bus_attribute_;
    ::wolong::agent::v2::BikeAttribute* bike_attribute_;
    int32_t id_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_wolong_2fagent_2fv2_2fagent_2eproto;
...
class Agents final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:wolong.agent.v2.Agents) */ {
 public:
  ...
  // repeated .wolong.agent.v2.Agent agents = 1;
  int agents_size() const;
  private:
  int _internal_agents_size() const;
  public:
  void clear_agents();
  ::wolong::agent::v2::Agent* mutable_agents(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::wolong::agent::v2::Agent >*
      mutable_agents();
  private:
  const ::wolong::agent::v2::Agent& _internal_agents(int index) const;
  ::wolong::agent::v2::Agent* _internal_add_agents();
  public:
  const ::wolong::agent::v2::Agent& agents(int index) const;
  ::wolong::agent::v2::Agent* add_agents();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::wolong::agent::v2::Agent >&
      agents() const;

  // @@protoc_insertion_point(class_scope:wolong.agent.v2.Agents)
 private:
  class _Internal;
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::wolong::agent::v2::Agent > agents_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_wolong_2fagent_2fv2_2fagent_2eproto;
...
inline ::wolong::agent::v2::AgentType AgentAttribute::_internal_type() const {
  return static_cast< ::wolong::agent::v2::AgentType >(_impl_.type_);
}
inline ::wolong::agent::v2::AgentType AgentAttribute::type() const {
  // @@protoc_insertion_point(field_get:wolong.agent.v2.AgentAttribute.type)
  return _internal_type();
}
inline void AgentAttribute::_internal_set_type(::wolong::agent::v2::AgentType value) {
  
  _impl_.type_ = value;
}
inline void AgentAttribute::set_type(::wolong::agent::v2::AgentType value) {
  _internal_set_type(value);
  // @@protoc_insertion_point(field_set:wolong.agent.v2.AgentAttribute.type)
}
...
inline double AgentAttribute::length() const {
  // @@protoc_insertion_point(field_get:wolong.agent.v2.AgentAttribute.length)
...
inline void AgentAttribute::set_length(double value) {
  ...
  // @@protoc_insertion_point(field_set:wolong.agent.v2.AgentAttribute.length)
}
...
inline double AgentAttribute::width() const {
  // @@protoc_insertion_point(field_get:wolong.agent.v2.AgentAttribute.width)
...
inline void AgentAttribute::set_width(double value) {
  ...
  // @@protoc_insertion_point(field_set:wolong.agent.v2.AgentAttribute.width)
}
...
inline double AgentAttribute::max_speed() const {
  // @@protoc_insertion_point(field_get:wolong.agent.v2.AgentAttribute.max_speed)
...
inline void AgentAttribute::set_max_speed(double value) {
  ...
  // @@protoc_insertion_point(field_set:wolong.agent.v2.AgentAttribute.max_speed)
}
...
inline double AgentAttribute::max_acceleration() const {
  // @@protoc_insertion_point(field_get:wolong.agent.v2.AgentAttribute.max_acceleration)
...
inline void AgentAttribute::set_max_acceleration(double value) {
  ...
  // @@protoc_insertion_point(field_set:wolong.agent.v2.AgentAttribute.max_acceleration)
}
...
inline double AgentAttribute::max_braking_acceleration() const {
  // @@protoc_insertion_point(field_get:wolong.agent.v2.AgentAttribute.max_braking_acceleration)
...
inline void AgentAttribute::set_max_braking_acceleration(double value) {
  ...
  // @@protoc_insertion_point(field_set:wolong.agent.v2.AgentAttribute.max_braking_acceleration)
}
...
inline double AgentAttribute::usual_acceleration() const {
  // @@protoc_insertion_point(field_get:wolong.agent.v2.AgentAttribute.usual_acceleration)
...
inline void AgentAttribute::set_usual_acceleration(double value) {
  ...
  // @@protoc_insertion_point(field_set:wolong.agent.v2.AgentAttribute.usual_acceleration)
}
...
inline double AgentAttribute::usual_braking_acceleration() const {
  // @@protoc_insertion_point(field_get:wolong.agent.v2.AgentAttribute.usual_braking_acceleration)
...
inline void AgentAttribute::set_usual_braking_acceleration(double value) {
  ...
  // @@protoc_insertion_point(field_set:wolong.agent.v2.AgentAttribute.usual_braking_acceleration)
}
...
inline double VehicleAttribute::lane_change_length() const {
  // @@protoc_insertion_point(field_get:wolong.agent.v2.VehicleAttribute.lane_change_length)
...
inline void VehicleAttribute::set_lane_change_length(double value) {
  ...
  // @@protoc_insertion_point(field_set:wolong.agent.v2.VehicleAttribute.lane_change_length)
}
...
inline double VehicleAttribute::min_gap() const {
  // @@protoc_insertion_point(field_get:wolong.agent.v2.VehicleAttribute.min_gap)
...
inline void VehicleAttribute::set_min_gap(double value) {
  ...
  // @@protoc_insertion_point(field_set:wolong.agent.v2.VehicleAttribute.min_gap)
}
...
inline int32_t BusAttribute::line_id() const {
  // @@protoc_insertion_point(field_get:wolong.agent.v2.BusAttribute.line_id)
...
inline void BusAttribute::set_line_id(int32_t value) {
  ...
  // @@protoc_insertion_point(field_set:wolong.agent.v2.BusAttribute.line_id)
}
...
inline int32_t BusAttribute::capacity() const {
  // @@protoc_insertion_point(field_get:wolong.agent.v2.BusAttribute.capacity)
...
inline void BusAttribute::set_capacity(int32_t value) {
  ...
  // @@protoc_insertion_point(field_set:wolong.agent.v2.BusAttribute.capacity)
}
...
inline int32_t Agent::id() const {
  // @@protoc_insertion_point(field_get:wolong.agent.v2.Agent.id)
  return _internal_id();
}
...
inline void Agent::set_id(int32_t value) {
  ...
  // @@protoc_insertion_point(field_set:wolong.agent.v2.Agent.id)
}
...
inline const ::wolong::agent::v2::AgentAttribute& Agent::_internal_attribute() const {
  const ::wolong::agent::v2::AgentAttribute* p = _impl_.attribute_;
  return p != nullptr ? *p : reinterpret_cast<const ::wolong::agent::v2::AgentAttribute&>(
      ::wolong::agent::v2::_AgentAttribute_default_instance_);
}
inline const ::wolong::agent::v2::AgentAttribute& Agent::attribute() const {
  // @@protoc_insertion_point(field_get:wolong.agent.v2.Agent.attribute)
...
inline void Agent::unsafe_arena_set_allocated_attribute(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:wolong.agent.v2.Agent.attribute)
}
inline ::wolong::agent::v2::AgentAttribute* Agent::release_attribute() {
  
  ::wolong::agent::v2::AgentAttribute* temp = _impl_.attribute_;
  _impl_.attribute_ = nullptr;
...
inline ::wolong::agent::v2::AgentAttribute* Agent::unsafe_arena_release_attribute() {
  // @@protoc_insertion_point(field_release:wolong.agent.v2.Agent.attribute)
  
  ::wolong::agent::v2::AgentAttribute* temp = _impl_.attribute_;
  _impl_.attribute_ = nullptr;
  return temp;
}
inline ::wolong::agent::v2::AgentAttribute* Agent::_internal_mutable_attribute() {
  
  if (_impl_.attribute_ == nullptr) {
    auto* p = CreateMaybeMessage<::wolong::agent::v2::AgentAttribute>(GetArenaForAllocation());
    _impl_.attribute_ = p;
  }
  return _impl_.attribute_;
}
inline ::wolong::agent::v2::AgentAttribute* Agent::mutable_attribute() {
  ::wolong::agent::v2::AgentAttribute* _msg = _internal_mutable_attribute();
  // @@protoc_insertion_point(field_mutable:wolong.agent.v2.Agent.attribute)
  return _msg;
}
inline void Agent::set_allocated_attribute(::wolong::agent::v2::AgentAttribute* attribute) {
  ...
  _impl_.attribute_ = attribute;
  // @@protoc_insertion_point(field_set_allocated:wolong.agent.v2.Agent.attribute)
}
...
inline const ::wolong::geo::v2::Position& Agent::_internal_home() const {
  const ::wolong::geo::v2::Position* p = _impl_.home_;
  return p != nullptr ? *p : reinterpret_cast<const ::wolong::geo::v2::Position&>(
      ::wolong::geo::v2::_Position_default_instance_);
}
inline const ::wolong::geo::v2::Position& Agent::home() const {
  // @@protoc_insertion_point(field_get:wolong.agent.v2.Agent.home)
...
inline void Agent::unsafe_arena_set_allocated_home(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:wolong.agent.v2.Agent.home)
}
inline ::wolong::geo::v2::Position* Agent::release_home() {
  
  ::wolong::geo::v2::Position* temp = _impl_.home_;
...
inline ::wolong::geo::v2::Position* Agent::unsafe_arena_release_home() {
  // @@protoc_insertion_point(field_release:wolong.agent.v2.Agent.home)
  
  ::wolong::geo::v2::Position* temp = _impl_.home_;
  _impl_.home_ = nullptr;
  return temp;
}
inline ::wolong::geo::v2::Position* Agent::_internal_mutable_home() {
  
  if (_impl_.home_ == nullptr) {
    auto* p = CreateMaybeMessage<::wolong::geo::v2::Position>(GetArenaForAllocation());
    _impl_.home_ = p;
  }
  return _impl_.home_;
}
inline ::wolong::geo::v2::Position* Agent::mutable_home() {
  ::wolong::geo::v2::Position* _msg = _internal_mutable_home();
  // @@protoc_insertion_point(field_mutable:wolong.agent.v2.Agent.home)
  return _msg;
}
inline void Agent::set_allocated_home(::wolong::geo::v2::Position* home) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.home_);
  }
  ...
  _impl_.home_ = home;
  // @@protoc_insertion_point(field_set_allocated:wolong.agent.v2.Agent.home)
}
...
inline ::wolong::trip::v2::Schedule* Agent::mutable_schedules(int index) {
  // @@protoc_insertion_point(field_mutable:wolong.agent.v2.Agent.schedules)
  return _impl_.schedules_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::wolong::trip::v2::Schedule >*
Agent::mutable_schedules() {
  // @@protoc_insertion_point(field_mutable_list:wolong.agent.v2.Agent.schedules)
  return &_impl_.schedules_;
}
inline const ::wolong::trip::v2::Schedule& Agent::_internal_schedules(int index) const {
  return _impl_.schedules_.Get(index);
}
inline const ::wolong::trip::v2::Schedule& Agent::schedules(int index) const {
  // @@protoc_insertion_point(field_get:wolong.agent.v2.Agent.schedules)
  return _internal_schedules(index);
}
inline ::wolong::trip::v2::Schedule* Agent::_internal_add_schedules() {
  return _impl_.schedules_.Add();
}
inline ::wolong::trip::v2::Schedule* Agent::add_schedules() {
  ::wolong::trip::v2::Schedule* _add = _internal_add_schedules();
  // @@protoc_insertion_point(field_add:wolong.agent.v2.Agent.schedules)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::wolong::trip::v2::Schedule >&
Agent::schedules() const {
  // @@protoc_insertion_point(field_list:wolong.agent.v2.Agent.schedules)
  return _impl_.schedules_;
}
...
inline const ::wolong::agent::v2::VehicleAttribute& Agent::_internal_vehicle_attribute() const {
  const ::wolong::agent::v2::VehicleAttribute* p = _impl_.vehicle_attribute_;
  return p != nullptr ? *p : reinterpret_cast<const ::wolong::agent::v2::VehicleAttribute&>(
      ::wolong::agent::v2::_VehicleAttribute_default_instance_);
}
inline const ::wolong::agent::v2::VehicleAttribute& Agent::vehicle_attribute() const {
  // @@protoc_insertion_point(field_get:wolong.agent.v2.Agent.vehicle_attribute)
...
inline void Agent::unsafe_arena_set_allocated_vehicle_attribute(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:wolong.agent.v2.Agent.vehicle_attribute)
}
inline ::wolong::agent::v2::VehicleAttribute* Agent::release_vehicle_attribute() {
  _impl_._has_bits_[0] &= ~0x00000001u;
  ::wolong::agent::v2::VehicleAttribute* temp = _impl_.vehicle_attribute_;
...
inline ::wolong::agent::v2::VehicleAttribute* Agent::unsafe_arena_release_vehicle_attribute() {
  // @@protoc_insertion_point(field_release:wolong.agent.v2.Agent.vehicle_attribute)
  _impl_._has_bits_[0] &= ~0x00000001u;
  ::wolong::agent::v2::VehicleAttribute* temp = _impl_.vehicle_attribute_;
  _impl_.vehicle_attribute_ = nullptr;
  return temp;
}
inline ::wolong::agent::v2::VehicleAttribute* Agent::_internal_mutable_vehicle_attribute() {
  _impl_._has_bits_[0] |= 0x00000001u;
  if (_impl_.vehicle_attribute_ == nullptr) {
    auto* p = CreateMaybeMessage<::wolong::agent::v2::VehicleAttribute>(GetArenaForAllocation());
    _impl_.vehicle_attribute_ = p;
  }
  return _impl_.vehicle_attribute_;
}
inline ::wolong::agent::v2::VehicleAttribute* Agent::mutable_vehicle_attribute() {
  ::wolong::agent::v2::VehicleAttribute* _msg = _internal_mutable_vehicle_attribute();
  // @@protoc_insertion_point(field_mutable:wolong.agent.v2.Agent.vehicle_attribute)
  return _msg;
}
inline void Agent::set_allocated_vehicle_attribute(::wolong::agent::v2::VehicleAttribute* vehicle_attribute) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
  ...
  _impl_.vehicle_attribute_ = vehicle_attribute;
  // @@protoc_insertion_point(field_set_allocated:wolong.agent.v2.Agent.vehicle_attribute)
}
...
inline const ::wolong::agent::v2::BusAttribute& Agent::_internal_bus_attribute() const {
  const ::wolong::agent::v2::BusAttribute* p = _impl_.bus_attribute_;
  return p != nullptr ? *p : reinterpret_cast<const ::wolong::agent::v2::BusAttribute&>(
      ::wolong::agent::v2::_BusAttribute_default_instance_);
}
inline const ::wolong::agent::v2::BusAttribute& Agent::bus_attribute() const {
  // @@protoc_insertion_point(field_get:wolong.agent.v2.Agent.bus_attribute)
...
inline void Agent::unsafe_arena_set_allocated_bus_attribute(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:wolong.agent.v2.Agent.bus_attribute)
}
inline ::wolong::agent::v2::BusAttribute* Agent::release_bus_attribute() {
  _impl_._has_bits_[0] &= ~0x00000002u;
  ::wolong::agent::v2::BusAttribute* temp = _impl_.bus_attribute_;
...
inline ::wolong::agent::v2::BusAttribute* Agent::unsafe_arena_release_bus_attribute() {
  // @@protoc_insertion_point(field_release:wolong.agent.v2.Agent.bus_attribute)
  _impl_._has_bits_[0] &= ~0x00000002u;
  ::wolong::agent::v2::BusAttribute* temp = _impl_.bus_attribute_;
  _impl_.bus_attribute_ = nullptr;
  return temp;
}
inline ::wolong::agent::v2::BusAttribute* Agent::_internal_mutable_bus_attribute() {
  _impl_._has_bits_[0] |= 0x00000002u;
  if (_impl_.bus_attribute_ == nullptr) {
    auto* p = CreateMaybeMessage<::wolong::agent::v2::BusAttribute>(GetArenaForAllocation());
    _impl_.bus_attribute_ = p;
  }
  return _impl_.bus_attribute_;
}
inline ::wolong::agent::v2::BusAttribute* Agent::mutable_bus_attribute() {
  ::wolong::agent::v2::BusAttribute* _msg = _internal_mutable_bus_attribute();
  // @@protoc_insertion_point(field_mutable:wolong.agent.v2.Agent.bus_attribute)
  return _msg;
}
inline void Agent::set_allocated_bus_attribute(::wolong::agent::v2::BusAttribute* bus_attribute) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
  ...
  _impl_.bus_attribute_ = bus_attribute;
  // @@protoc_insertion_point(field_set_allocated:wolong.agent.v2.Agent.bus_attribute)
}
...
inline const ::wolong::agent::v2::BikeAttribute& Agent::_internal_bike_attribute() const {
  const ::wolong::agent::v2::BikeAttribute* p = _impl_.bike_attribute_;
  return p != nullptr ? *p : reinterpret_cast<const ::wolong::agent::v2::BikeAttribute&>(
      ::wolong::agent::v2::_BikeAttribute_default_instance_);
}
inline const ::wolong::agent::v2::BikeAttribute& Agent::bike_attribute() const {
  // @@protoc_insertion_point(field_get:wolong.agent.v2.Agent.bike_attribute)
...
inline void Agent::unsafe_arena_set_allocated_bike_attribute(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:wolong.agent.v2.Agent.bike_attribute)
}
inline ::wolong::agent::v2::BikeAttribute* Agent::release_bike_attribute() {
  _impl_._has_bits_[0] &= ~0x00000004u;
  ::wolong::agent::v2::BikeAttribute* temp = _impl_.bike_attribute_;
...
inline ::wolong::agent::v2::BikeAttribute* Agent::unsafe_arena_release_bike_attribute() {
  // @@protoc_insertion_point(field_release:wolong.agent.v2.Agent.bike_attribute)
  _impl_._has_bits_[0] &= ~0x00000004u;
  ::wolong::agent::v2::BikeAttribute* temp = _impl_.bike_attribute_;
  _impl_.bike_attribute_ = nullptr;
  return temp;
}
inline ::wolong::agent::v2::BikeAttribute* Agent::_internal_mutable_bike_attribute() {
  _impl_._has_bits_[0] |= 0x00000004u;
  if (_impl_.bike_attribute_ == nullptr) {
    auto* p = CreateMaybeMessage<::wolong::agent::v2::BikeAttribute>(GetArenaForAllocation());
    _impl_.bike_attribute_ = p;
  }
  return _impl_.bike_attribute_;
}
inline ::wolong::agent::v2::BikeAttribute* Agent::mutable_bike_attribute() {
  ::wolong::agent::v2::BikeAttribute* _msg = _internal_mutable_bike_attribute();
  // @@protoc_insertion_point(field_mutable:wolong.agent.v2.Agent.bike_attribute)
  return _msg;
}
inline void Agent::set_allocated_bike_attribute(::wolong::agent::v2::BikeAttribute* bike_attribute) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
  ...
  _impl_.bike_attribute_ = bike_attribute;
  // @@protoc_insertion_point(field_set_allocated:wolong.agent.v2.Agent.bike_attribute)
}
...
inline const ::PROTOBUF_NAMESPACE_ID::Map< std::string, std::string >&
Agent::labels() const {
  // @@protoc_insertion_point(field_map:wolong.agent.v2.Agent.labels)
...
Agent::mutable_labels() {
  // @@protoc_insertion_point(field_mutable_map:wolong.agent.v2.Agent.labels)
...
inline ::wolong::agent::v2::Agent* Agents::mutable_agents(int index) {
  // @@protoc_insertion_point(field_mutable:wolong.agent.v2.Agents.agents)
  return _impl_.agents_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::wolong::agent::v2::Agent >*
Agents::mutable_agents() {
  // @@protoc_insertion_point(field_mutable_list:wolong.agent.v2.Agents.agents)
  return &_impl_.agents_;
}
inline const ::wolong::agent::v2::Agent& Agents::_internal_agents(int index) const {
  return _impl_.agents_.Get(index);
}
inline const ::wolong::agent::v2::Agent& Agents::agents(int index) const {
  // @@protoc_insertion_point(field_get:wolong.agent.v2.Agents.agents)
  return _internal_agents(index);
}
inline ::wolong::agent::v2::Agent* Agents::_internal_add_agents() {
  return _impl_.agents_.Add();
}
inline ::wolong::agent::v2::Agent* Agents::add_agents() {
  ::wolong::agent::v2::Agent* _add = _internal_add_agents();
  // @@protoc_insertion_point(field_add:wolong.agent.v2.Agents.agents)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::wolong::agent::v2::Agent >&
Agents::agents() const {
  // @@protoc_insertion_point(field_list:wolong.agent.v2.Agents.agents)
  return _impl_.agents_;
}
...
template <> struct is_proto_enum< ::wolong::agent::v2::AgentType> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::wolong::agent::v2::AgentType>() {
  return ::wolong::agent::v2::AgentType_descriptor();
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_wolong_2fagent_2fv2_2fagent_2eproto
