...
static ::_pb::Metadata file_level_metadata_wolong_2ftrip_2fv2_2ftrip_2eproto[2];
static const ::_pb::EnumDescriptor* file_level_enum_descriptors_wolong_2ftrip_2fv2_2ftrip_2eproto[1];
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_wolong_2ftrip_2fv2_2ftrip_2eproto = nullptr;

const uint32_t TableStruct_wolong_2ftrip_2fv2_2ftrip_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::wolong::trip::v2::Trip, _impl_._has_bits_),
  PROTOBUF_FIELD_OFFSET(::wolong::trip::v2::Trip, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::wolong::trip::v2::Trip, _impl_.mode_),
  PROTOBUF_FIELD_OFFSET(::wolong::trip::v2::Trip, _impl_.end_),
  PROTOBUF_FIELD_OFFSET(::wolong::trip::v2::Trip, _impl_.departure_time_),
  PROTOBUF_FIELD_OFFSET(::wolong::trip::v2::Trip, _impl_.wait_time_),
  PROTOBUF_FIELD_OFFSET(::wolong::trip::v2::Trip, _impl_.arrival_time_),
  PROTOBUF_FIELD_OFFSET(::wolong::trip::v2::Trip, _impl_.activity_),
  PROTOBUF_FIELD_OFFSET(::wolong::trip::v2::Trip, _impl_.routes_),
  ~0u,
  ~0u,
  1,
  2,
  ...
  0,
  ~0u,
  PROTOBUF_FIELD_OFFSET(::wolong::trip::v2::Schedule, _impl_._has_bits_),
  PROTOBUF_FIELD_OFFSET(::wolong::trip::v2::Schedule, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::wolong::trip::v2::Schedule, _impl_.trips_),
  PROTOBUF_FIELD_OFFSET(::wolong::trip::v2::Schedule, _impl_.loop_count_),
  PROTOBUF_FIELD_OFFSET(::wolong::trip::v2::Schedule, _impl_.departure_time_),
  PROTOBUF_FIELD_OFFSET(::wolong::trip::v2::Schedule, _impl_.wait_time_),
  ~0u,
  ~0u,
  0,
  1,
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 13, -1, sizeof(::wolong::trip::v2::Trip)},
  { 20, 30, -1, sizeof(::wolong::trip::v2::Schedule)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::wolong::trip::v2::_Trip_default_instance_._instance,
  &::wolong::trip::v2::_Schedule_default_instance_._instance,
};

const char descriptor_table_protodef_wolong_2ftrip_2fv2_2ftrip_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\031wolong/trip/v2/trip.proto\022\016wolong.trip"
  ".v2\032\027wolong/geo/v2/geo.proto\032\037wolong/rou"
  "ting/v2/routing.proto\"\246\002\n\004Trip\022&\n\004mode\030\001"
  " \001(\0162\030.wolong.trip.v2.TripMode\022$\n\003end\030\002 "
  "\001(\0132\027.wolong.geo.v2.Position\022\033\n\016departur"
  "e_time\030\003 \001(\001H\000\210\001\001\022\026\n\twait_time\030\004 \001(\001H\001\210\001"
  "\001\022\031\n\014arrival_time\030\005 \001(\001H\002\210\001\001\022\025\n\010activity"
  "\030\006 \001(\tH\003\210\001\001\022*\n\006routes\030\007 \003(\0132\032.wolong.rou"
  "ting.v2.JourneyB\021\n\017_departure_timeB\014\n\n_w"
  "ait_timeB\017\n\r_arrival_timeB\013\n\t_activity\"\231"
  "\001\n\010Schedule\022#\n\005trips\030\001 \003(\0132\024.wolong.trip"
  ".v2.Trip\022\022\n\nloop_count\030\002 \001(\005\022\033\n\016departur"
  "e_time\030\003 \001(\001H\000\210\001\001\022\026\n\twait_time\030\004 \001(\001H\001\210\001"
  "\001B\021\n\017_departure_timeB\014\n\n_wait_time*\326\001\n\010T"
  "ripMode\022\031\n\025TRIP_MODE_UNSPECIFIED\020\000\022\027\n\023TR"
  "IP_MODE_WALK_ONLY\020\001\022\030\n\024TRIP_MODE_DRIVE_O"
  "NLY\020\002\022\027\n\023TRIP_MODE_TAXI_ONLY\020\003\022\026\n\022TRIP_M"
  "ODE_BUS_WALK\020\004\022\027\n\023TRIP_MODE_BIKE_WALK\020\005\022"
  "\030\n\024TRIP_MODE_COST_FIRST\020\006\022\030\n\024TRIP_MODE_T"
  "IME_FIRST\020\007b\006proto3"
  ;
static const ::_pbi::DescriptorTable* const descriptor_table_wolong_2ftrip_2fv2_2ftrip_2eproto_deps[2] = {
  &::descriptor_table_wolong_2fgeo_2fv2_2fgeo_2eproto,
  &::descriptor_table_wolong_2frouting_2fv2_2frouting_2eproto,
};
static ::_pbi::once_flag descriptor_table_wolong_2ftrip_2fv2_2ftrip_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_wolong_2ftrip_2fv2_2ftrip_2eproto = {
    false, false, 779, descriptor_table_protodef_wolong_2ftrip_2fv2_2ftrip_2eproto,
    "wolong/trip/v2/trip.proto",
    &descriptor_table_wolong_2ftrip_2fv2_2ftrip_2eproto_once, descriptor_table_wolong_2ftrip_2fv2_2ftrip_2eproto_deps, 2, 2,
    schemas, file_default_instances, TableStruct_wolong_2ftrip_2fv2_2ftrip_2eproto::offsets,
    file_level_metadata_wolong_2ftrip_2fv2_2ftrip_2eproto, file_level_enum_descriptors_wolong_2ftrip_2fv2_2ftrip_2eproto,
    file_level_service_descriptors_wolong_2ftrip_2fv2_2ftrip_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_wolong_2ftrip_2fv2_2ftrip_2eproto_getter() {
  return &descriptor_table_wolong_2ftrip_2fv2_2ftrip_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_wolong_2ftrip_2fv2_2ftrip_2eproto(&descriptor_table_wolong_2ftrip_2fv2_2ftrip_2eproto);
namespace wolong {
namespace trip {
namespace v2 {
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* TripMode_descriptor() {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_wolong_2ftrip_2fv2_2ftrip_2eproto);
  return file_level_enum_descriptors_wolong_2ftrip_2fv2_2ftrip_2eproto[0];
}
...
class Trip::_Internal {
 public:
  ...
  static const ::wolong::geo::v2::Position& end(const Trip* msg);
...
Trip::Trip(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:wolong.trip.v2.Trip)
}
Trip::Trip(const Trip& from)
  ...
  // @@protoc_insertion_point(copy_constructor:wolong.trip.v2.Trip)
}
...
Trip::~Trip() {
  // @@protoc_insertion_point(destructor:wolong.trip.v2.Trip)
...
void Trip::Clear() {
// @@protoc_insertion_point(message_clear_start:wolong.trip.v2.Trip)
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 8)) {
          ...
          CHK_(ptr);
          _internal_set_mode(static_cast<::wolong::trip::v2::TripMode>(val));
        } else
          goto handle_unusual;
        continue;
      ...
      case 6:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 50)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "wolong.trip.v2.Trip.activity"));
        } else
          goto handle_unusual;
        continue;
...
uint8_t* Trip::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:wolong.trip.v2.Trip)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:wolong.trip.v2.Trip)
  return target;
}

size_t Trip::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:wolong.trip.v2.Trip)
  size_t total_size = 0;
...
void Trip::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:wolong.trip.v2.Trip)
...
// @@protoc_insertion_point(class_specific_copy_from_start:wolong.trip.v2.Trip)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata Trip::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_wolong_2ftrip_2fv2_2ftrip_2eproto_getter, &descriptor_table_wolong_2ftrip_2fv2_2ftrip_2eproto_once,
      file_level_metadata_wolong_2ftrip_2fv2_2ftrip_2eproto[0]);
}
...
Schedule::Schedule(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:wolong.trip.v2.Schedule)
}
Schedule::Schedule(const Schedule& from)
  ...
  // @@protoc_insertion_point(copy_constructor:wolong.trip.v2.Schedule)
}
...
Schedule::~Schedule() {
  // @@protoc_insertion_point(destructor:wolong.trip.v2.Schedule)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
void Schedule::Clear() {
// @@protoc_insertion_point(message_clear_start:wolong.trip.v2.Schedule)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
uint8_t* Schedule::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:wolong.trip.v2.Schedule)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:wolong.trip.v2.Schedule)
  return target;
}

size_t Schedule::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:wolong.trip.v2.Schedule)
  size_t total_size = 0;
...
void Schedule::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:wolong.trip.v2.Schedule)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:wolong.trip.v2.Schedule)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata Schedule::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_wolong_2ftrip_2fv2_2ftrip_2eproto_getter, &descriptor_table_wolong_2ftrip_2fv2_2ftrip_2eproto_once,
      file_level_metadata_wolong_2ftrip_2fv2_2ftrip_2eproto[1]);
}
...
template<> PROTOBUF_NOINLINE ::wolong::trip::v2::Trip*
Arena::CreateMaybeMessage< ::wolong::trip::v2::Trip >(Arena* arena) {
  return Arena::CreateMessageInternal< ::wolong::trip::v2::Trip >(arena);
}
template<> PROTOBUF_NOINLINE ::wolong::trip::v2::Schedule*
Arena::CreateMaybeMessage< ::wolong::trip::v2::Schedule >(Arena* arena) {
  return Arena::CreateMessageInternal< ::wolong::trip::v2::Schedule >(arena);
}
