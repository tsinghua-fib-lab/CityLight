...
#ifndef GOOGLE_PROTOBUF_INCLUDED_wolong_2ftrip_2fv2_2ftrip_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_wolong_2ftrip_2fv2_2ftrip_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_wolong_2ftrip_2fv2_2ftrip_2eproto
...
struct TableStruct_wolong_2ftrip_2fv2_2ftrip_2eproto {
  static const uint32_t offsets[];
};
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_wolong_2ftrip_2fv2_2ftrip_2eproto;
namespace wolong {
namespace trip {
namespace v2 {
class Schedule;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::wolong::trip::v2::Schedule* Arena::CreateMaybeMessage<::wolong::trip::v2::Schedule>(Arena*);
template<> ::wolong::trip::v2::Trip* Arena::CreateMaybeMessage<::wolong::trip::v2::Trip>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace wolong {
namespace trip {
namespace v2 {
...
constexpr TripMode TripMode_MAX = TRIP_MODE_TIME_FIRST;
...
class Trip final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:wolong.trip.v2.Trip) */ {
 public:
  ...
  public:
  void clear_routes();
  ::wolong::routing::v2::Journey* mutable_routes(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::wolong::routing::v2::Journey >*
      mutable_routes();
  private:
  const ::wolong::routing::v2::Journey& _internal_routes(int index) const;
  ::wolong::routing::v2::Journey* _internal_add_routes();
  public:
  const ::wolong::routing::v2::Journey& routes(int index) const;
  ::wolong::routing::v2::Journey* add_routes();
  ...
  // .wolong.trip.v2.TripMode mode = 1;
  void clear_mode();
  ::wolong::trip::v2::TripMode mode() const;
  void set_mode(::wolong::trip::v2::TripMode value);
  private:
  ::wolong::trip::v2::TripMode _internal_mode() const;
  void _internal_set_mode(::wolong::trip::v2::TripMode value);
  public:

  // @@protoc_insertion_point(class_scope:wolong.trip.v2.Trip)
 private:
  class _Internal;
  ...
  struct Impl_ {
    ...
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::wolong::routing::v2::Journey > routes_;
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_wolong_2ftrip_2fv2_2ftrip_2eproto;
};
// -------------------------------------------------------------------

class Schedule final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:wolong.trip.v2.Schedule) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "wolong.trip.v2.Schedule";
  }
  protected:
  ...
  // repeated .wolong.trip.v2.Trip trips = 1;
  int trips_size() const;
  private:
  int _internal_trips_size() const;
  public:
  void clear_trips();
  ::wolong::trip::v2::Trip* mutable_trips(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::wolong::trip::v2::Trip >*
      mutable_trips();
  private:
  const ::wolong::trip::v2::Trip& _internal_trips(int index) const;
  ::wolong::trip::v2::Trip* _internal_add_trips();
  public:
  const ::wolong::trip::v2::Trip& trips(int index) const;
  ::wolong::trip::v2::Trip* add_trips();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::wolong::trip::v2::Trip >&
      trips() const;
  ...
  // @@protoc_insertion_point(class_scope:wolong.trip.v2.Schedule)
 private:
  class _Internal;
  ...
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::internal::HasBits<1> _has_bits_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::wolong::trip::v2::Trip > trips_;
    double departure_time_;
    double wait_time_;
    int32_t loop_count_;
  };
...
inline ::wolong::trip::v2::TripMode Trip::_internal_mode() const {
  return static_cast< ::wolong::trip::v2::TripMode >(_impl_.mode_);
}
inline ::wolong::trip::v2::TripMode Trip::mode() const {
  // @@protoc_insertion_point(field_get:wolong.trip.v2.Trip.mode)
  return _internal_mode();
}
inline void Trip::_internal_set_mode(::wolong::trip::v2::TripMode value) {
  
  _impl_.mode_ = value;
}
inline void Trip::set_mode(::wolong::trip::v2::TripMode value) {
  _internal_set_mode(value);
  // @@protoc_insertion_point(field_set:wolong.trip.v2.Trip.mode)
}
...
inline const ::wolong::geo::v2::Position& Trip::_internal_end() const {
...
inline const ::wolong::geo::v2::Position& Trip::end() const {
  // @@protoc_insertion_point(field_get:wolong.trip.v2.Trip.end)
...
inline void Trip::unsafe_arena_set_allocated_end(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:wolong.trip.v2.Trip.end)
}
inline ::wolong::geo::v2::Position* Trip::release_end() {
...
inline ::wolong::geo::v2::Position* Trip::unsafe_arena_release_end() {
  // @@protoc_insertion_point(field_release:wolong.trip.v2.Trip.end)
  
  ::wolong::geo::v2::Position* temp = _impl_.end_;
  _impl_.end_ = nullptr;
  return temp;
}
inline ::wolong::geo::v2::Position* Trip::_internal_mutable_end() {
...
inline ::wolong::geo::v2::Position* Trip::mutable_end() {
  ::wolong::geo::v2::Position* _msg = _internal_mutable_end();
  // @@protoc_insertion_point(field_mutable:wolong.trip.v2.Trip.end)
  return _msg;
}
inline void Trip::set_allocated_end(::wolong::geo::v2::Position* end) {
  ...
  _impl_.end_ = end;
  // @@protoc_insertion_point(field_set_allocated:wolong.trip.v2.Trip.end)
}
...
inline double Trip::departure_time() const {
  // @@protoc_insertion_point(field_get:wolong.trip.v2.Trip.departure_time)
...
inline void Trip::set_departure_time(double value) {
  ...
  // @@protoc_insertion_point(field_set:wolong.trip.v2.Trip.departure_time)
}
...
inline double Trip::wait_time() const {
  // @@protoc_insertion_point(field_get:wolong.trip.v2.Trip.wait_time)
...
inline void Trip::set_wait_time(double value) {
  ...
  // @@protoc_insertion_point(field_set:wolong.trip.v2.Trip.wait_time)
}
...
inline double Trip::arrival_time() const {
  // @@protoc_insertion_point(field_get:wolong.trip.v2.Trip.arrival_time)
...
inline void Trip::set_arrival_time(double value) {
  ...
  // @@protoc_insertion_point(field_set:wolong.trip.v2.Trip.arrival_time)
}
...
inline const std::string& Trip::activity() const {
  // @@protoc_insertion_point(field_get:wolong.trip.v2.Trip.activity)
...
void Trip::set_activity(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.activity_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:wolong.trip.v2.Trip.activity)
}
inline std::string* Trip::mutable_activity() {
  std::string* _s = _internal_mutable_activity();
  // @@protoc_insertion_point(field_mutable:wolong.trip.v2.Trip.activity)
  return _s;
}
...
inline std::string* Trip::release_activity() {
  // @@protoc_insertion_point(field_release:wolong.trip.v2.Trip.activity)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:wolong.trip.v2.Trip.activity)
}
...
inline ::wolong::routing::v2::Journey* Trip::mutable_routes(int index) {
  // @@protoc_insertion_point(field_mutable:wolong.trip.v2.Trip.routes)
  return _impl_.routes_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::wolong::routing::v2::Journey >*
Trip::mutable_routes() {
  // @@protoc_insertion_point(field_mutable_list:wolong.trip.v2.Trip.routes)
  return &_impl_.routes_;
}
inline const ::wolong::routing::v2::Journey& Trip::_internal_routes(int index) const {
  return _impl_.routes_.Get(index);
}
inline const ::wolong::routing::v2::Journey& Trip::routes(int index) const {
  // @@protoc_insertion_point(field_get:wolong.trip.v2.Trip.routes)
  return _internal_routes(index);
}
inline ::wolong::routing::v2::Journey* Trip::_internal_add_routes() {
  return _impl_.routes_.Add();
}
inline ::wolong::routing::v2::Journey* Trip::add_routes() {
  ::wolong::routing::v2::Journey* _add = _internal_add_routes();
  // @@protoc_insertion_point(field_add:wolong.trip.v2.Trip.routes)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::wolong::routing::v2::Journey >&
Trip::routes() const {
  // @@protoc_insertion_point(field_list:wolong.trip.v2.Trip.routes)
  return _impl_.routes_;
}
...
inline ::wolong::trip::v2::Trip* Schedule::mutable_trips(int index) {
  // @@protoc_insertion_point(field_mutable:wolong.trip.v2.Schedule.trips)
  return _impl_.trips_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::wolong::trip::v2::Trip >*
Schedule::mutable_trips() {
  // @@protoc_insertion_point(field_mutable_list:wolong.trip.v2.Schedule.trips)
  return &_impl_.trips_;
}
inline const ::wolong::trip::v2::Trip& Schedule::_internal_trips(int index) const {
  return _impl_.trips_.Get(index);
}
inline const ::wolong::trip::v2::Trip& Schedule::trips(int index) const {
  // @@protoc_insertion_point(field_get:wolong.trip.v2.Schedule.trips)
  return _internal_trips(index);
}
inline ::wolong::trip::v2::Trip* Schedule::_internal_add_trips() {
  return _impl_.trips_.Add();
}
inline ::wolong::trip::v2::Trip* Schedule::add_trips() {
  ::wolong::trip::v2::Trip* _add = _internal_add_trips();
  // @@protoc_insertion_point(field_add:wolong.trip.v2.Schedule.trips)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::wolong::trip::v2::Trip >&
Schedule::trips() const {
  // @@protoc_insertion_point(field_list:wolong.trip.v2.Schedule.trips)
  return _impl_.trips_;
}
...
inline int32_t Schedule::loop_count() const {
  // @@protoc_insertion_point(field_get:wolong.trip.v2.Schedule.loop_count)
...
inline void Schedule::set_loop_count(int32_t value) {
  ...
  // @@protoc_insertion_point(field_set:wolong.trip.v2.Schedule.loop_count)
}
...
inline double Schedule::departure_time() const {
  // @@protoc_insertion_point(field_get:wolong.trip.v2.Schedule.departure_time)
  return _internal_departure_time();
}
...
inline void Schedule::set_departure_time(double value) {
  _internal_set_departure_time(value);
  // @@protoc_insertion_point(field_set:wolong.trip.v2.Schedule.departure_time)
}
...
inline double Schedule::wait_time() const {
  // @@protoc_insertion_point(field_get:wolong.trip.v2.Schedule.wait_time)
  return _internal_wait_time();
}
...
inline void Schedule::set_wait_time(double value) {
  _internal_set_wait_time(value);
  // @@protoc_insertion_point(field_set:wolong.trip.v2.Schedule.wait_time)
}
...
template <> struct is_proto_enum< ::wolong::trip::v2::TripMode> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::wolong::trip::v2::TripMode>() {
  return ::wolong::trip::v2::TripMode_descriptor();
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_wolong_2ftrip_2fv2_2ftrip_2eproto
