...
#ifndef GOOGLE_PROTOBUF_INCLUDED_wolong_2frouting_2fv2_2fcost_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_wolong_2frouting_2fv2_2fcost_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_wolong_2frouting_2fv2_2fcost_2eproto
...
struct TableStruct_wolong_2frouting_2fv2_2fcost_2eproto {
  static const uint32_t offsets[];
};
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_wolong_2frouting_2fv2_2fcost_2eproto;
namespace wolong {
namespace routing {
namespace v2 {
class Cost;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::wolong::routing::v2::Cost* Arena::CreateMaybeMessage<::wolong::routing::v2::Cost>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace wolong {
namespace routing {
namespace v2 {
...
class Cost final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:wolong.routing.v2.Cost) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:wolong.routing.v2.Cost)
 private:
  class _Internal;
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_wolong_2frouting_2fv2_2fcost_2eproto;
};
// ===================================================================
...
inline int32_t Cost::id() const {
  // @@protoc_insertion_point(field_get:wolong.routing.v2.Cost.id)
  return _internal_id();
}
...
inline void Cost::set_id(int32_t value) {
  ...
  // @@protoc_insertion_point(field_set:wolong.routing.v2.Cost.id)
}
...
inline double Cost::cost() const {
  // @@protoc_insertion_point(field_get:wolong.routing.v2.Cost.cost)
...
inline void Cost::set_cost(double value) {
  ...
  // @@protoc_insertion_point(field_set:wolong.routing.v2.Cost.cost)
}
...
inline double Cost::time() const {
  // @@protoc_insertion_point(field_get:wolong.routing.v2.Cost.time)
...
inline void Cost::set_time(double value) {
  ...
  // @@protoc_insertion_point(field_set:wolong.routing.v2.Cost.time)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_wolong_2frouting_2fv2_2fcost_2eproto
